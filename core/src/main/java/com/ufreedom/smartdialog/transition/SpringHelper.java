...
public class SpringHelper {
    ...
    public void start(final Rebound rebound){
        if (mConfig == -1){
        ...
        Spring spring = null;
        if (mConfig == 0){
            spring = rebound.createSpringByBouncinessAndSpeed(mConfigValueOne, mConfigValueTwo);
        }else if (mConfig == 1){
            spring = rebound.createSpringByTensionAndFriction(mConfigValueOne, mConfigValueTwo);
        }
        start(spring);
    }
